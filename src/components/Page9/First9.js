    ...
    return (
      <div className="main-middle2 main-top clearfix">
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Ытык эт алгыһа</h2>
          <br />
          <p>
            Аан Айыы Тойон, <br />
            Бэттэх көрөн
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Молитва о восприимчивости</h2>
          <br />
          <p>
            Почтенный Бог-господин,
            <br />
            Посмотри на меня,
            <br />
            ...
            <br />
            <br />
            Пусть будет прямой осанка
            <br />
            И приподнятым настроение.
            <br />
            <br />
