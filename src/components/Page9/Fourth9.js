    ...
    return (
      <div className="main-middle2 main-top clearfix">
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Туом алгыһа</h2>
          <br />
          <p>
            Туом Айыы Тойон,
            <br />
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Обрядовая молитва</h2>
          <br />
          <p>
            Владыка Обрядов,
            <br />
            ...
            <br />
            Выскажу добрые слова.
            <br />
            <br />
            Буду связываться с Тангра
            <br />
            ...
            <br />
            <br />
            Буду жить хорошо на солнечной земле.
            <br />
            Да будет так!
            <br />
            <br />
