    ...
    return (
      <div className="main-middle2 main-top clearfix">
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Батыһыы алгыһа</h2>
          <br />
          <p>
            Төрүт Суорун,
            <br />
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Молитва о примере предков</h2>
          <br />
          <p>
            Главный Небесный Царь,
            <br />
            Повернись ко мне,
            <br />
            ...
            <br />
            Продолжу потомственную нить.
            <br />
            <br />
            Пусть вдыхаемая сила
            <br />
            ...
            <br />
            <br />
            Буду слушаться советов
            <br />
            Своих предков.
            <br />
            <br />
            Хочу стать совершенным человеком
            <br />
            Нашедшим себя.
            <br />
            Да будет так!
