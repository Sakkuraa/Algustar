    ...
    return (
      <div className="main-middle2 main-top clearfix">
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Дьоҕур алгыһа</h2>
          <br />
          <p>
            Аан Суорун,
            <br />
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Молитва о раскрытии способностей</h2>
          <br />
          <p>
            Почтенный Небесный Царь,
            <br />
            Повернись ко мне,
            <br />
