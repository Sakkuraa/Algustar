    ...
    return (
      <div className="main-middle2 main-top clearfix">
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Арыллыы алгыһа</h2>
          <br />
          <p>
            Түстүр Суорун,
            <br />
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Молитва об определении предназначения</h2>
          <br />
          <p>
            Небесный Царь Предназначения,
            <br />
            Повернись ко мне,
            <br />
            ...
            <br />
            <br />
            Руководствуясь хорошим
            <br />
            Продуманным словом,
            <br />
            <br />
            Буду следовать лучшему,
            <br />
            Что есть под белым солнцем.
            <br />
            <br />
            Пусть мозг открывается знаниям
            <br />
            И тело созревает.
            <br />
            <br />
            ...
            <br />
            <br />
            Мой благоразумный мозг
            <br />
            Будет воспринимать правду.
            <br />
            <br />
            Выберу путь развития
            <br />
