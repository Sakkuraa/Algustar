		...
		return(
			<div className="main-middle2 main-top clearfix">
				...
				<div className="ipostasi"><br/>						
						...
						<p> <br/>
                		Первая основная ипостась Тангра,
							помещаемая на первом небе, отвечающая за семейное счастье, <br/>7 ипостасей которой в якутской
							обрядовой поэзии представляется в виде женщин.<br/><br/>
