    ...
    return (
      <div className="main-middle2 main-top clearfix">
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Кырдьык алгыһа</h2>
          <br />
          <p>
            Күөгэл Хаан, <br />
            Бэттэх көрөн
        ...
        <article>
          <br />
          <br />
          <h2 align="center">Молитва о правде</h2>
          <br />
          <p>
            Величественный Владыка,
            <br />
            Посмотри на меня,
            <br />
            ...
            <br />
            <br />
            Да будут мысли светлыми,
            <br />
            Пусть будет ум ясным.
            <br />
            <br />
            Не буду пачкаться
            <br />
